...
def cost_of_solution(G, closed_walk, conquered_set):
    ...
    if cost != 'infinite':
        ...
        message += 'The conquering cost of your solution is {}\n'.format(conquering_cost)
        message += 'The travelling cost of your solution is {}\n'.format(travelling_cost)

    message += 'The total cost of your solution is {}'.format(cost)
    return cost, message
